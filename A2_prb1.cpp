...
int maximumShopsVisited(vector<int>& S, vector<int>& E, int K) {
    int N = S.size();
    vector<Shop> shops(N);
...
int main() {
    vector<int> S1 = {1, 8, 3, 5, 3};
    vector<int> E1 = {4, 10, 6, 7, 9};
    int K1 = 2;
    cout << "Maximum shops visited: " << maximumShopsVisited(S1, E1, K1) << endl;

    vector<int> S2 = {1, 2, 3};
    vector<int> E2 = {3, 4, 5};
    int K2 = 2;
    cout << "Maximum shops visited: " << maximumShopsVisited(S2, E2, K2) << endl;
